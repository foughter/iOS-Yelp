...
//- (AFHTTPRequestOperation *)searchWithTerm:(NSString *)term Deal:(BOOL)hasDeal success:(void (^)(AFHTTPRequestOperation *operation, id response))success failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure;
